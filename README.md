...
<a href="https://modrinth.com/mod/savemod/versions?g=1.20.2">
...
- A config screen (need [Mod Menu](https://modrinth.com/mod/modmenu/versions?g=1.20.2))

## Dependency

<a href="https://modrinth.com/mod/fabric-api/versions?g=1.20.2">
<img width="150" src="readme_assets/requires_fabric_api.png" alt="Requires Fabric API">
</a>

## Optional dependency

You may use [Mod Menu](https://modrinth.com/mod/modmenu/versions?g=1.20.2) to configure the mod in-game, but it can also be configured by editing the `savemod.properties` file, located in the `config` directory.
